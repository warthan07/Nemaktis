...
https://github.com/warthan07/Nemaktis/releases/download/v1.4.6/Install_Nemaktis-1.4.6.cmd

This script will ask for the root path of the anaconda distribution installed in step a,
...
installed Spyder, since it has to be run from inside the conda environment *nm*).
...
terminal" installed with miniconda, Linux: any terminal) and type the following command: ::
  ...
  mamba create -n nm -c conda-forge -c warthan07 -y nemaktis=1.4.6
